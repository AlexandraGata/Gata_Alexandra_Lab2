...
namespace Gata_Alexandra_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Gata_Alexandra_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Gata_Alexandra_Lab2Context context,
